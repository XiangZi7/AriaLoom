...
import { MusicPlayerState, MusicPlayerProviderProps } from '@/model/interface/store/audio';
...
export const useSharedMusicPlayer = (): MusicPlayerState => {
  ...
  if (context === undefined) {
    throw new Error('useSharedMusicPlayer must be used within a MusicPlayerProvider');
  }
  return context;
};
