      ...
      <footer className="flex items-center p-4 z-10">
        <div className="flex flex-col md:grid md:grid-cols-3 md:items-center w-full justify-between space-y-4 md:space-y-0">
          <div className="flex items-center gap-4 justify-center md:justify-start">
            <Avatar radius="sm" alt="Avatar" size="lg" src={track.cover + '?param=60y60'} onClick={showModal} />
            <div className="grid gap-0.5">
              <p className="text-sm font-semibold text-center md:text-left">{track.title}</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center md:text-left">{track.singer}</p>
            </div>
          </div>
          <div className="flex flex-col items-center">
            ...
            <div className="flex gap-2 w-full items-center">
              <span className="text-small w-10 text-foreground/50">{formatMillisecondsToTime(currentTime)}</span>
              <Slider
                ...
                size="sm"
              />
              <span className="text-small w-10 text-foreground/50">{formatMillisecondsToTime(duration)}</span>
            </div>
          </div>
