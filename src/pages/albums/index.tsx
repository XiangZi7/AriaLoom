  ...
  return (
    <div className="flex flex-col items-center justify-center px-4">
      <div className="shadow-lg rounded-lg overflow-hidden md:max-w-2xl transition-all duration-500 hover:shadow-2xl">
        <img src="https://via.placeholder.com/500" alt="Album Cover" className="w-full h-64 object-cover" />
        <div className="p-6 md:p-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">专辑名称</h2>
